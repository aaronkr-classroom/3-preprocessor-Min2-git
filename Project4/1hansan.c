...
void showStatus(unsigned char fleet)
{
	...
	if (fleet & CMD_HOLD)		printf("후퇴 준비중\n");
...
int main(void)
{
	...
	while (1)
	{
		...
		case 8:
			fleet = 0;
			printf("모든 함성 상태 초기화 완료!\n");
			break;
		case 9:
			printf("총무송 점검: 현재 모든 함성 상태 확인!\n");
			break;
		case 10:
			fleet = 0x7f; //모든 비트 ON
			printf("전면 돌격 모드! 모든 명령 활성화!\n");
			break;
		case 11:
			printf("프로그램 종료합니다.\n");
			return 0;
		default:
			printf("잘못된 입력입니다.(1~11)선택!\n");
		}// switch()
